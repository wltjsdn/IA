...
from calapp.form import BlogUpdate
...
def new(request):
    ...
    return render(request, 'new.html', request, 'new.html', {'fulltext': full_text, 'total': 
len(word_list), 'dictionary': word_dictionary.items()} )
